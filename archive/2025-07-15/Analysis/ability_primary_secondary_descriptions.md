...
* Ceres's Rejuvenator: Restores {**Primär.x**}% armor per second to itself for 8 seconds and creates a healing area within {**Sekundär.x**}m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**Primary.x**}% armor per second to itself for 8 seconds and creates a healing area within {**Secondary.x**}m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**Primario.x**}% armor per second to itself for 8 seconds and creates a healing area within {**Secundario.x**} m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**Primaire.x**}% armor per second to itself for 8 seconds and creates a healing area within {**Secondaire.x**} m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**メイン.x**}% armor per second to itself for 8 seconds and creates a healing area within {**サブ.x**}m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**주.x**}% armor per second to itself for 8 seconds and creates a healing area within {**보조.x**}m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**Podstawowy.x**}% armor per second to itself for 8 seconds and creates a healing area within {**Drugoplanowy.x**} m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**Primário.x**}% armor per second to itself for 8 seconds and creates a healing area within {**Secundário.x**}m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**Основное.x**}% armor per second to itself for 8 seconds and creates a healing area within {**Второстепенное.x**}м of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**Birincil.x**}% armor per second to itself for 8 seconds and creates a healing area within {**İkincil.x**}m of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**主.x**}% armor per second to itself for 8 seconds and creates a healing area within {**副.x**}米 of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
...
* Ceres's Rejuvenator: Restores {**主要.x**}% armor per second to itself for 8 seconds and creates a healing area within {**次要.x**}公尺 of itself. If there is at least one allied robot in the area, both Ceres and all allies will receive twice the amount of repairs.  Cooldown {CD}.
